 ...
 * @author DELL
 */
public class CA_Login extends javax.swing.JFrame {
    public static String CA_username;
    Connection conn = null;
    OraclePreparedStatement pst = null;
    OracleResultSet rs = null;
    /**
     * Creates new form CA_LOGIN
     */
    public CA_Login() {
        initComponents();
    }
    ...
    private void LoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginActionPerformed
        ...
        CA_username = user_id.getText();
        try
        {

            String sql = "select * from Collection_Agent where USERNAME=? and PASSWORD=?";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CA_Login.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
