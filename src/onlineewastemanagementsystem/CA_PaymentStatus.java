 ...
 * @author DHAWALE
 */
public class CA_PaymentStatus extends javax.swing.JFrame {
    Connection conn = null;
    OraclePreparedStatement pst = null;
    OracleResultSet rs = null;
    /**
     * Creates new form CA_PaymentStatus
     */
    public CA_PaymentStatus() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        ...
                        .addGap(38, 38, 38)
                        .addComponent(productid, javax.swing.GroupLayout.PREFERRED_SIZE, 230, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel6Layout.createSequentialGroup()
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addGap(143, 143, 143)
                .addComponent(SignUp2, javax.swing.GroupLayout.PREFERRED_SIZE, 172, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel5.add(jPanel6);
        jPanel6.setBounds(60, 220, 470, 280);
        ...
        jLabel17.setText("Update Status");
        ...
        jPanel5.add(jPanel8);
        jPanel8.setBounds(270, 100, 410, 80);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(jPanel5, javax.swing.GroupLayout.PREFERRED_SIZE, 998, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void SignUp2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SignUp2ActionPerformed
        ...
        try
        {
            ...
            String sql = "update payment set status = ? where pid = ?";
            pst = (OraclePreparedStatement) conn.prepareStatement(sql);
            pst.setString(2,productid.getText());
            pst.setString(1,status.getText());
            rs = (OracleResultSet) pst.executeQuery();

            if(rs.next())
            {
                JOptionPane.showMessageDialog(null, "Status Update successfully...");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CA_PaymentStatus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CA_PaymentStatus().setVisible(true);
            }
        });
    }
