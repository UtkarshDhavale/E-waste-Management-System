...
import static onlineewastemanagementsystem.CA_Login.CA_username;
 ...
 * @author DHAWALE
 */
public class CA_Profile extends javax.swing.JFrame {
    Connection conn = null;
    OraclePreparedStatement pst = null;
    OracleResultSet rs = null;
    /**
     * Creates new form CA_Profile
     */
    public CA_Profile() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton4.setBounds(70, 460, 160, 60);
        ...
        jButton5.setBounds(310, 460, 160, 60);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        conn = JavaConnectDb.connecrDb();
            ...
            String sql = "select * from Collection_Agent where username=?";
            pst = (OraclePreparedStatement) conn.prepareStatement(sql);
            pst.setString(1, CA_username);
            rs = (OracleResultSet) pst.executeQuery();
            if(rs.next()){}
            
                username.setText(CA_username);
                ...
                String d=rs.getString("MOBILE_NO");
                mobno.setText(d);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CA_Profile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CA_Profile().setVisible(true);
            }
        });
    }
